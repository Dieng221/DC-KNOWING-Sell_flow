                   ...
                   <table class="table mb-0 mt-4 adv-table" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                      <thead>
                         <tr class="userDatatable-header">
                            ...
                            <th><span class="userDatatable-title">Numéro d'identification fiscale</span></th>
                            <th><span class="userDatatable-title">Solde d'ouverture</span></th>
                            <th><span class="userDatatable-title">Limite de crédit</span></th>
                                     ...
                                     <td>
                                       ...
                                       <td>
                                          <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                             <li>
                                                <a href="{{route('partners.show', 1)}}" class="view">
                                                   <i class="uil uil-eye"></i>
                                                </a>
                                             </li>
                                             <li>
                                                <a href="{{route('partners.edit', 1)}}" class="edit">
                                                   <i class="uil uil-edit"></i>
                                                </a>
                                             </li>
                                             <li>
                                                <a href="{{route('partners.delete', 1)}}" class="remove">
