...
@section('content')
   ...
   <div class="container-fluid">
             ...
             <div class="breadcrumb-action justify-content-center flex-wrap">
                <nav aria-label="breadcrumb">
                   <ol class="breadcrumb">
                      ...
                      <a href="#"><i class="uil uil-estate"></i>Vente</a>
                   ...
                   <div class="row">
                    <div class="col-md-6 mb-25">
                        <select class="form-control ih-medium ip-gray radius-xs b-light px-15" name="module">
                            ...
                            <option value="Bim Bara">Dieng Ibrahima</option>
                            <option value="Bim Livraison">Ndouffou Nazaire</option>
                            <option value="Bim Dabali">Konan Silas</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-25">
                        <select class="form-control ih-medium ip-gray radius-xs b-light px-15" name="module">
                     ...
                     <div class="col-md-6 mb-25">
                      ...
                      <div class="col-md-6 mb-25">
                        <select class="form-control ih-medium ip-gray radius-xs b-light px-15" name="module">
                            ...
                            <option value="Bim Bara">Final</option>
                            <option value="Bim Livraison">Devis</option>
                        </select>
                    </div>
                      <div class="col-md-6 mb-25">
                         <input type="text" name="facture" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="Facture n°">
                      </div>
                      <div class="col-md-6 mb-25">
                        <select class="form-control ih-medium ip-gray radius-xs b-light px-15" name="module">
    ...
    <div class="row align-items-center mb-3 product-row">
        ...
        <div class="col-md-3">
            <input type="number" name="discounts[]" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="Valeur de la remise" min="0" step="0.01">
        </div>
            ...
            <button type="button" class="btn btn-danger btn-squared px-30 remove-product">Supprimer</button>
                      ...
                      <div class="col-md-12 form-group mb-25 form-group-calender">
                        <div class="position-relative">
                           <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" id="datepicker" placeholder="Date de vente">
