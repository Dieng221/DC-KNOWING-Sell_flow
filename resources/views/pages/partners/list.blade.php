                   ...
                   <table class="table mb-0 mt-4 adv-table" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                      <thead>
                         <tr class="userDatatable-header">
                            <th><span class="userDatatable-title">Nom ou Raison sociale</span></th>
                            <th><span class="userDatatable-title">Type de partenariat</span></th>
                            <th><span class="userDatatable-title">Contat téléphonique</span></th>
                            <th><span class="userDatatable-title">Ligne fixe</span></th>
                            <th><span class="userDatatable-title">Email</span></th>
                            <th><span class="userDatatable-title">Adresse de l'entreprise</span></th>
                            <th><span class="userDatatable-title">Statut du partenaire</span></th>
                      ...
                      <tbody>
                                ...
                                <tr>
                                    <td>
                                       <div class="userDatatable-content">{{$partner->nom}}</div>
                                    </td>
                                    <td>
                                       <div class="d-flex">
                                          <div class="userDatatable-inline-title">
                                             <a href="" class="text-dark fw-500">
                                                <h6>{{$partner->type_partenariat}}</h6>
                                             </a>
                                          </div>
                                       </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="userDatatable-content d-inline-block">
                                           <span class="bg-opacity-success  color-success rounded-pill userDatatable-content-status active">{{$partner->statut}}</span>
                                        </div>
                                     </td>
                                    <td>
                                       <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                          <li>
                                             <a href="{{route('partners.show', $partner->id)}}" class="view">
                                                <i class="uil uil-eye"></i>
                                             </a>
                                          </li>
                                          <li>
                                             <a href="{{route('partners.edit', $partner->id)}}" class="edit">
                                                <i class="uil uil-edit"></i>
                                             </a>
                                          </li>
                                          <li>
                                             <a href="{{route('partners.delete', $partner->id)}}" class="remove">
