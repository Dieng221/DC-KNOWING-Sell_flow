                   ...
                   <div class="ps-tab p-20 pb-25">
                      <div class="nav flex-column text-start" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                         ...
                         <a class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill" href="#v-pills-settings" role="tab" aria-selected="false">
                            <img class="svg" src="img/svg/users.svg" alt="users">social profiles</a>
                                     ...
                                     <div class="edit-profile__body mx-xl-20">
                                        <form>
                                           ...
                                           <div class="button-group d-flex flex-wrap pt-30 mb-15">
                                              ...
                                              <button class="btn btn-primary btn-default btn-squared me-15 text-capitalize btn-sm">update profile
                                              </button>
                                              ...
                                              <button class="btn btn-light btn-default btn-squared fw-400 text-capitalize btn-sm">cancel
                                              </button>
